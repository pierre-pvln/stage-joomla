:: Name:     pscp_to_downloadserver.cmd
:: Purpose:  Transfer files to downloadserver using pscp
...
::
:: Run the script
"%staging_command%" -l %user_downloadserver% -pw %pw_downloadserver% %output_dir%\index.html %downloadserver%:%download_folder%
"%staging_command%" -l %user_downloadserver% -pw %pw_downloadserver% %output_dir%\%extensionprefix%%extension%_%version%.zip %downloadserver%:%download_folder%
