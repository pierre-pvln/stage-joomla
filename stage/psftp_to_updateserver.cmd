...
:: Purpose:  Transfer files to updateserver using psftp
...
"%staging_command%" -b %temporary_folder%\_update_files.txt -be -l %user_updateserver% -pw %pw_updateserver% %updateserver%
:: Remove %temporary_folder%\_update_files.txt file													 
